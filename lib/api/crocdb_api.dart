...
class CrocDbApi {
  ...
  Future<List<Region>> getRegions() async {
    ...
    return regions.entries.map((entry) {
      return Region(id: entry.key, name: entry.value as String);
    }).toList();
  }
  ...
  Future<SearchResult> search({
    ...
    final Map<String, dynamic> body = {'page': page, 'max_results': maxResults};
  ...
  Future<RomEntry> getEntry(String slug) async {
    ...
    return RomEntry.fromJson(
      responseData['data']['entry'] as Map<String, dynamic>,
    );
  }
